...
import { Briefcase, Mail, Users, Building2, Award, ChartBar, CirclePlus, Verified } from 'lucide-react';
    ...
    <Layout>
      <div className="min-h-[100dvh] p-6 mt-[75px]">
        ...
        <div className="w-full flex justify-end my-8">
          <div onClick={()=>navigate.push('/verify-document')} className="bg-primary/50 px-4 py-3 text-lg rounded-md flex gap-2 items-center hover:bg-primary/30 cursor-pointer  ">
          <CirclePlus className='h-6 w-6' />Verify Document</div>
        </div>
